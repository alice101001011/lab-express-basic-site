...
const episodes = [
  {
    ...
    description:
      "Mr. Bean attends a maths exam, during which he tries to copy from a student under the nose of the invigilator; he surreptitiously changes into his swimming trunks so as not to be noticed by someone nearby; and he struggles to stay awake during a church service, much to the annoyance of the man sitting next to him, Mr. Sprout.",
  },
  {
    episode: 2,
    ...
    description:
      "Bean busks to pay a busker, tries out his new credit card in a department store, visits a restaurant and is served an unwanted dish, leading him to try a variety of strategies to avoid eating it, and then has an unfortunate altercation with Queen Elizabeth The Queen Mother.",
  },
  {
    episode: 3,
  ...
  },
  {
    ...
    description:
      "Bean buys a new portable television but seems to be having difficulty getting a good reception. He then has his camera stolen in the park and later finds a unique way of identifying the culprit. After leaving his shoe on top of a car, Bean finds himself hopping around town to retrieve it.",
  },
  {
    episode: 5,
  ...
  },
  {
    ...
    aired: "25 April 1994",
    description:
      "While visiting Southsea, Bean accidentally becomes lumbered with a baby, with no idea of how or where it came from. So he does the honourable thing of treating it to a day at the funfair. Somehow, the baby manages to survive Bean's unique style of mishaps before thankfully being reunited with its mother.",
  },
  {
    episode: 11,
    ...
    description:
      "Bean attends an open day at a school and unleashes his usual brand of chaos in the various classes he visits. Despite all his fun, Bean's day takes a sombre turn when he discovers that his cherished Mini is not where he left it.",
  },
  {
    episode: 12,
    ...
    description:
      "After causing chaos in the town launderette, Bean tries his hand at Crazy Golf, but after being told he can only touch the ball with the club, Bean's poor aim leads him on an elaborate tour around town before returning to the course several hours later to score 3,427.",
  },
  {
    episode: 13,
